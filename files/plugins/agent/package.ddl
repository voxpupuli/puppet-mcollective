...
action "yum_update", :description => "Update all packages using YUM" do
    output :output,
           :description => "Output from YUM",
           :display_as  => "Output"
...
action "yum_upgrade", :description => "Update all packages using YUM taking obsoletes into account" do
    output :output,
           :description => "Output from YUM",
           :display_as  => "Output"
